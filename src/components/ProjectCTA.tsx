...
const ProjectCTA = () => {
    ...
    return (
        <section className="container mx-auto px-4 text-center py-4 md:py-20">
            <MagicCard className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-12 max-w-4xl mx-auto hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-300 hover:-translate-y-1" gradientColor="#6366f1">
